...
function FlipCameraAndroidIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    d: "M16 15C16 15.55 16.45 16 17 16H18.91C17.53 18.39 14.95 20 12 20C8.51 20 5.55 17.76 4.46 14.64C4.32 14.25 3.93 14 3.52 14C2.84 14 2.34 14.67 2.56 15.31C3.93 19.21 7.64 22 12 22C15.27 22 18.18 20.42 20 17.99V19C20 19.55 20.45 20 21 20C21.55 20 22 19.55 22 19V15C22 14.45 21.55 14 21 14H17C16.45 14 16 14.45 16 15Z",
    fill: "currentColor"
  }));
}

module.exports = FlipCameraAndroidIcon;