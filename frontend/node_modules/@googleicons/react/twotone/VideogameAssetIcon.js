...
function VideogameAssetIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M3 16H21V8H3V16ZM18.5 9C19.33 9 20 9.67 20 10.5C20 11.33 19.33 12 18.5 12C17.67 12 17 11.33 17 10.5C17 9.67 17.67 9 18.5 9ZM14.5 12C15.33 12 16 12.67 16 13.5C16 14.33 15.33 15 14.5 15C13.67 15 13 14.33 13 13.5C13 12.67 13.67 12 14.5 12ZM4 11H6V9H8V11H10V13H8V15H6V13H4V11Z",
    fill: "currentColor"
