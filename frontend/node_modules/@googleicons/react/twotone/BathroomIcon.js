...
function BathroomIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M4 20H20V4H4V20ZM9 18C8.45 18 8 17.55 8 17C8 16.45 8.45 16 9 16C9.55 16 10 16.45 10 17C10 17.55 9.55 18 9 18ZM9 15C8.45 15 8 14.55 8 14C8 13.45 8.45 13 9 13C9.55 13 10 13.45 10 14C10 14.55 9.55 15 9 15ZM12 18C11.45 18 11 17.55 11 17C11 16.45 11.45 16 12 16C12.55 16 13 16.45 13 17C13 17.55 12.55 18 12 18ZM12 15C11.45 15 11 14.55 11 14C11 13.45 11.45 13 12 13C12.55 13 13 13.45 13 14C13 14.55 12.55 15 12 15ZM15 18C14.45 18 14 17.55 14 17C14 16.45 14.45 16 15 16C15.55 16 16 16.45 16 17C16 17.55 15.55 18 15 18ZM15 15C14.45 15 14 14.55 14 14C14 13.45 14.45 13 15 13C15.55 13 16 13.45 16 14C16 14.55 15.55 15 15 15ZM7 11C7 8.24 9.24 6 12 6C14.76 6 17 8.24 17 11V12H7V11Z",
    fill: "currentColor"
    ...
    d: "M17 11C17 8.24 14.76 6 12 6C9.24 6 7 8.24 7 11V12H17V11ZM8.54 10.5C8.78 8.81 10.24 7.5 12 7.5C13.76 7.5 15.22 8.81 15.47 10.5H8.54Z",
    fill: "currentColor"
  }), /*#__PURE__*/React.createElement("path", {
