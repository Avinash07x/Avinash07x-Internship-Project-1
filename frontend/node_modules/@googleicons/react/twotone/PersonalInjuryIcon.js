...
function PersonalInjuryIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M12 4C13.1 4 14 4.9 14 6C14 7.1 13.1 8 12 8C10.9 8 10 7.1 10 6C10 4.9 10.9 4 12 4ZM10.94 20H9.75C9.34 20 9 19.66 9 19.25C9 18.84 9.34 18.5 9.75 18.5H11.64L10.94 20ZM18 20H13.15L16.09 13.73C16.63 13.93 17.1 14.14 17.49 14.34C17.8 14.5 18 14.84 18 15.22V20ZM9.75 22C8.23 22 7 20.77 7 19.25C7 17.73 8.23 16.5 9.75 16.5H12.58L14.13 13.2C13.47 13.07 12.76 13 12 13C9.63 13 7.71 13.73 6.52 14.34C6.2 14.5 6 14.84 6 15.22V22H9.75Z",
    fill: "currentColor"
...
module.exports = PersonalInjuryIcon;