...
function SpeakerGroupIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M10 16.99L18 17V3H10V16.99ZM14 4C15.1 4 16 4.89 16 6C16 7.11 15.1 8 14 8C12.9 8 12 7.11 12 6C12 4.89 12.9 4 14 4ZM14 9C15.93 9 17.5 10.57 17.5 12.5C17.5 14.43 15.93 16 14 16C12.07 16 10.5 14.43 10.5 12.5C10.5 10.57 12.07 9 14 9Z",
    fill: "currentColor"
