...
function RestorePageIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M6 4V20H18V8.83L13.17 4H6ZM16.72 13C16.72 15.48 14.7 17.5 12.22 17.5C10.38 17.5 8.79 16.38 8.1 14.8H9.64C10.21 15.61 11.15 16.15 12.22 16.15C13.96 16.15 15.37 14.74 15.37 13C15.37 11.26 13.96 9.85 12.22 9.85C11.01 9.85 9.95 10.55 9.43 11.56L10.88 13H7.28V9.4L8.45 10.57C9.25 9.33 10.64 8.5 12.23 8.5C14.71 8.5 16.72 10.52 16.72 13Z",
    fill: "currentColor"
...
module.exports = RestorePageIcon;