...
function SurroundSoundIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M4 18H20V6H4V18ZM16.94 7.06C18.32 8.41 19 10.21 19 12C19 13.79 18.32 15.59 16.95 16.95L15.72 15.72C16.74 14.69 17.25 13.35 17.25 12C17.25 10.65 16.73 9.31 15.71 8.29L16.94 7.06ZM12 8.5C13.93 8.5 15.5 10.07 15.5 12C15.5 13.93 13.93 15.5 12 15.5C10.07 15.5 8.5 13.93 8.5 12C8.5 10.07 10.07 8.5 12 8.5ZM7.05 7.05L8.28 8.28C7.27 9.31 6.75 10.65 6.75 12C6.75 13.35 7.27 14.69 8.29 15.71L7.06 16.94C5.68 15.59 5 13.79 5 12C5 10.21 5.68 8.41 7.05 7.05Z",
    fill: "currentColor"
...
module.exports = SurroundSoundIcon;