...
function TramIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M12.97 7H11.03C8.28 7.08 7.41 7.58 7.13 8H16.87C16.59 7.58 15.72 7.08 12.97 7ZM7 16V17C7 17.45 7.3 17.84 7.74 17.95H10.85C10.63 17.69 10.5 17.36 10.5 17C10.5 16.61 10.65 16.27 10.89 16H7ZM13.5 17C13.5 17.36 13.37 17.69 13.15 17.95H16.26C16.7 17.84 17 17.45 17 17V16H13.11C13.35 16.27 13.5 16.61 13.5 17Z",
    fill: "currentColor"
