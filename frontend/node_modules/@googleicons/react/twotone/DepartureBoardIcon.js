...
function DepartureBoardIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M9.29 6H9C5.31 6 3.89 6.46 3.34 6.99H9.08C9.13 6.66 9.2 6.32 9.29 6ZM3 14V18C3 18.37 3.21 18.62 3.34 18.73L3.63 19H14.37L14.66 18.73C14.79 18.62 15 18.37 15 18V14.92C14.06 14.79 13.19 14.47 12.41 14H3ZM5.5 18C4.67 18 4 17.33 4 16.5C4 15.67 4.67 15 5.5 15C6.33 15 7 15.67 7 16.5C7 17.33 6.33 18 5.5 18ZM14 16.5C14 17.33 13.33 18 12.5 18C11.67 18 11 17.33 11 16.5C11 15.67 11.67 15 12.5 15C13.33 15 14 15.67 14 16.5Z",
    fill: "currentColor"
