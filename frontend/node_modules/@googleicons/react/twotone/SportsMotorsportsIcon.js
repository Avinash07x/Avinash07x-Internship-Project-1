...
function SportsMotorsportsIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M13.56 6C13.41 6 13.27 6 13.12 6.01C11.67 6.11 10.4 6.44 9.3 7L11.8 8.06C13.13 8.63 14 9.93 14 11.38C14 13.37 12.38 14.99 10.39 14.99H4.24C4.01 16.28 4 17.19 4 17.2V18H14C15.68 18 17.3 17.29 18.44 16.04C19.59 14.77 20.14 13.13 19.98 11.41C19.69 8.37 16.87 6 13.56 6Z",
    fill: "currentColor"
