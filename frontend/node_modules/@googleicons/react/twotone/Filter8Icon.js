...
function Filter8Icon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M7 17H21V3H7V17ZM11 11.5C11 10.67 11.67 10 12.5 10C11.67 10 11 9.33 11 8.5V7C11 5.89 11.9 5 13 5H15C16.1 5 17 5.89 17 7V8.5C17 9.33 16.33 10 15.5 10C16.33 10 17 10.67 17 11.5V13C17 14.11 16.1 15 15 15H13C11.9 15 11 14.11 11 13V11.5ZM13 7H15V9H13V7ZM13 11H15V13H13V11Z",
    fill: "currentColor"
