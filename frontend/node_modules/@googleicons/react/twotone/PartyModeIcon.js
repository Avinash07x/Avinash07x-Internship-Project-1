...
function PartyModeIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M15.95 6L15.36 5.35L14.12 4H9.88L8.65 5.35L8.05 6H4V18H20V6H15.95ZM7 12C7 9.24 9.24 7 12 7C13.63 7 15.06 7.79 15.98 9H12C10.34 9 9 10.34 9 12C9 12.35 9.07 12.69 9.18 13H7.1C7.04 12.68 7 12.34 7 12ZM17 12C17 14.76 14.76 17 12 17C10.37 17 8.94 16.21 8.02 15H12C13.66 15 15 13.66 15 12C15 11.65 14.93 11.31 14.82 11H16.9C16.97 11.32 17 11.66 17 12Z",
    fill: "currentColor"
