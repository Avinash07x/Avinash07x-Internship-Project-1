...
function WhatshotIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M16.11 6.76953C15.58 9.36953 13.49 11.1995 10.83 11.1995C9.27 11.1995 7.87 10.5795 6.86 9.56953C6.3 10.9595 6 12.4695 6 13.9995C6 17.3095 8.69 19.9995 12 19.9995C15.31 19.9995 18 17.3095 18 13.9995C18 11.4395 17.34 8.96953 16.11 6.76953ZM11.89 17.9895C10.52 17.9895 9.4 16.9095 9.4 15.5695C9.4 14.3195 10.21 13.4395 11.57 13.1595C12.94 12.8795 14.35 12.2295 15.14 11.1695C15.44 12.1695 15.6 13.2195 15.6 14.2895C15.6 16.3295 13.94 17.9895 11.89 17.9895Z",
    fill: "currentColor"
