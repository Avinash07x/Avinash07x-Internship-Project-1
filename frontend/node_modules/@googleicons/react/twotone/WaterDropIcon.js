...
function WaterDropIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M12 4.66992C7.95 8.36992 6 11.4599 6 13.8099C6 17.4399 8.65 20.0099 12 20.0099C15.35 20.0099 18 17.4399 18 13.8099C18 11.4599 16.05 8.35992 12 4.66992ZM12.28 18.9899C10.15 19.1199 7.66 17.8999 7.09 14.8699C7.01 14.4199 7.37 13.9999 7.83 13.9999C8.2 13.9999 8.5 14.2599 8.57 14.6199C8.98 16.8499 10.85 17.5999 12.21 17.4899C12.64 17.4699 13 17.8099 13 18.2399C13 18.6399 12.68 18.9699 12.28 18.9899Z",
    fill: "currentColor"
