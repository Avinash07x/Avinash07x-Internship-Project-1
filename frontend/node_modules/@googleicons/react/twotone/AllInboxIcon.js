...
function AllInboxIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M8.13 10H5V12H9.4C8.8 11.47 8.34 10.78 8.13 10ZM14.6 12H19V10H15.87C15.66 10.78 15.2 11.47 14.6 12ZM8.22 17.25C8.19 17.17 8.16 17.09 8.13 17H5V19H9.4C8.87 18.53 8.46 17.93 8.22 17.25ZM15.87 17C15.85 17.09 15.81 17.17 15.78 17.25C15.55 17.93 15.14 18.53 14.6 19H19V17H15.87Z",
    fill: "currentColor"
  }));
}

module.exports = AllInboxIcon;