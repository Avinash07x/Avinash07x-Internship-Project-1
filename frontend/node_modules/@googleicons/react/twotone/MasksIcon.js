...
function MasksIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M14.34 8.78C13.52 8.33 12.93 8 12 8C11.07 8 10.48 8.33 9.66 8.77C8.95 9.16 8.12 9.62 7 9.85V11.5C7 14.26 9.24 16.5 12 16.5C14.76 16.5 17 14.26 17 11.5V9.85C15.88 9.62 15.05 9.16 14.34 8.78ZM15 11.25C14.25 11.04 13.74 10.74 13.29 10.47C12.83 10.2 12.49 10 12 10C11.51 10 11.16 10.2 10.69 10.48C10.25 10.74 9.73 11.04 9 11.24V10.2C9.48 10.03 9.84 9.82 10.18 9.62C10.72 9.3 11.23 9 12 9C12.77 9 13.27 9.3 13.8 9.62C14.14 9.82 14.51 10.04 15 10.21V11.25Z",
    fill: "currentColor"
