...
function KebabDiningIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M15.5 5C15.22 5 15 4.78 15 4.5C15 4.22 15.22 4 15.5 4H18.5C18.78 4 19 4.22 19 4.5C19 4.78 18.78 5 18.5 5H15.5ZM18.5 16C18.78 16 19 16.22 19 16.5C19 16.78 18.78 17 18.5 17H15.5C15.22 17 15 16.78 15 16.5C15 16.22 15.22 16 15.5 16H18.5ZM19 10V11H15V10H19ZM5.5 5C5.22 5 5 4.78 5 4.5C5 4.22 5.22 4 5.5 4H8.5C8.78 4 9 4.22 9 4.5C9 4.78 8.78 5 8.5 5H5.5ZM8.5 16C8.78 16 9 16.22 9 16.5C9 16.78 8.78 17 8.5 17H5.5C5.22 17 5 16.78 5 16.5C5 16.22 5.22 16 5.5 16H8.5ZM9 10V11H5V10H9Z",
    fill: "currentColor"
