...
function PointOfSaleIcon(props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    opacity: 0.3,
    d: "M9.5 16H8.5C8.22 16 8 15.78 8 15.5C8 15.22 8.22 15 8.5 15H9.5C9.78 15 10 15.22 10 15.5C10 15.78 9.78 16 9.5 16ZM10 13.5C10 13.22 9.78 13 9.5 13H8.5C8.22 13 8 13.22 8 13.5C8 13.78 8.22 14 8.5 14H9.5C9.78 14 10 13.78 10 13.5ZM10 11.5C10 11.22 9.78 11 9.5 11H8.5C8.22 11 8 11.22 8 11.5C8 11.78 8.22 12 8.5 12H9.5C9.78 12 10 11.78 10 11.5ZM13 15.5C13 15.22 12.78 15 12.5 15H11.5C11.22 15 11 15.22 11 15.5C11 15.78 11.22 16 11.5 16H12.5C12.78 16 13 15.78 13 15.5ZM13 13.5C13 13.22 12.78 13 12.5 13H11.5C11.22 13 11 13.22 11 13.5C11 13.78 11.22 14 11.5 14H12.5C12.78 14 13 13.78 13 13.5ZM13 11.5C13 11.22 12.78 11 12.5 11H11.5C11.22 11 11 11.22 11 11.5C11 11.78 11.22 12 11.5 12H12.5C12.78 12 13 11.78 13 11.5ZM16 15.5C16 15.22 15.78 15 15.5 15H14.5C14.22 15 14 15.22 14 15.5C14 15.78 14.22 16 14.5 16H15.5C15.78 16 16 15.78 16 15.5ZM16 13.5C16 13.22 15.78 13 15.5 13H14.5C14.22 13 14 13.22 14 13.5C14 13.78 14.22 14 14.5 14H15.5C15.78 14 16 13.78 16 13.5ZM16 11.5C16 11.22 15.78 11 15.5 11H14.5C14.22 11 14 11.22 14 11.5C14 11.78 14.22 12 14.5 12H15.5C15.78 12 16 11.78 16 11.5ZM17 4H7V6H17V4Z",
    fill: "currentColor"
...
module.exports = PointOfSaleIcon;